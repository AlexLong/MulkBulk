namespace MulkBulk.Domain.Migrations
{
    ...
    public partial class ChangedModel : DbMigration
    {
        public override void Up()
        {
            ...
            DropForeignKey("dbo.AspNetUsers", "ProfileId", "dbo.MulkUserProfiles");
            DropForeignKey("dbo.UserMessages", "AuthorId", "dbo.AspNetUsers");
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.MulkUserProfiles", t => t.ProfileId, cascadeDelete: true)
                .Index(t => t.ProfileId);
